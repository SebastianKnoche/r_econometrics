...
print(paste("Sample size =", length(bwght2[[1]])))
print(paste("Since R^2 is only", my_mlm_lbwght_2_r_sqr, "% and all couefficients are smaller than or equal to 0.5%, log(bwght) is a rather difficould variable to explain."))
```