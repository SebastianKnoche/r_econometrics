...
my_slm_smry_iq <- summary(my_slm_iq)
my_slm_r_sqr_iq <- round(my_slm_smry_iq$r.squared, 4) * 100
...
my_slm_smry_lwage <- summary(my_slm_lwage)
my_slm_r_sqr_lwage <- round(my_slm_smry_lwage$r.squared, 4) * 100
...
my_mlm_smry_lwage <- summary(my_mlm_lwage)
my_mlm_r_sqr_lwage <- round(my_mlm_smry_lwage$r.squared, 4) * 100
